...
const CartItem = ({ name, brand, price, quantity }) => {
  return (
    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
      <div className="flex w-full sm:w-2/5">
        <div className="w-20">
          <img className="h-24" src={test} alt={name} />
        </div>
...
const Cart = () => {
  const items = [
    { name: "Iphone 6S", brand: "Apple", price: 400, quantity: 1 },
    { name: "Dog Food", brand: "Pedigree", price: 50, quantity: 1 },
    { name: "Headphones", brand: "Sony", price: 100, quantity: 1 },
  ];
      ...
      <div className="flex flex-col lg:flex-row shadow-md my-10">
        ...
        <div id="summary" className="w-full lg:w-1/4 px-8 py-10">
          ...
          <div className="flex justify-between mt-10 mb-5">
            ...
            <span className="font-semibold text-sm">$550</span>
          </div>
          <div>
